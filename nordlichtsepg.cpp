    ...
    if (jumpto)
    {
        ...
        case k0 ... k9:
        {
            ...
            case 0:
                ...
                {
                    hh = number * 10;
                    snprintf(tmp, TMP_LENGTH, "%s: %1d-:--", tr("Jump to"), number);
                    index++;
                }
                break;
            // second digit
            case 1:
                ...
                {
                    hh += number;
                    snprintf(tmp, TMP_LENGTH, "%s: %02d:--", tr("Jump to"), hh);
                    index++;
                }
                break;
            // third digit
            case 2:
                ...
                {
                    mm = number * 10;
                    snprintf(tmp, TMP_LENGTH, "%s: %02d:%1d-", tr("Jump to"), hh, number);
                    index++;
                }
                break;
            // fourth digit
            case 3:
                mm += number;
                snprintf(tmp, TMP_LENGTH, "%s: %02d:%02d", tr("Jump to"), hh, mm);
                index++;
                break;
            default:
                break;
